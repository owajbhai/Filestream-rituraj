...
class Var(object):
    ...
    FQDN = str(getenv('FQDN', 'advancestreambot.onrender.com')) if not ON_HEROKU or getenv('FQDN') else APP_NAME + '.herokuapp.com'
    HAS_SSL = bool(getenv('HAS_SSL', False))

    if HAS_SSL:
        URL = "https://advancestreambot.onrender.com/".format(FQDN)
    else:
        URL = "https://advancestreambot.onrender.com/".format(FQDN)
